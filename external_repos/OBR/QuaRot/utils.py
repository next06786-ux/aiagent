...
def parser_gen():
    ...
    # General Arguments
    parser.add_argument('--model', type=str, default='/data2/guohang/pretrained/Llama-2-7b-hf',
    ...
    parser.add_argument('--w_clip', action='store_true', default=True,
    ...
    parser.add_argument('--capture_layer_io', action='store_true', default=False,
