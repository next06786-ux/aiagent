...
def parser_gen():
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Whether to use the OBR_RTN method, if False use OBR_GPTQ",
    )
    parser.add_argument(
        "--w_clip",
        action=argparse.BooleanOptionalAction,
    ...
    # Pruning sepecific parameters
    parser.add_argument("--sparsity_ratio", type=float,default=0.5,help="Clip ratio for k-cache quantization. new_max = max * clip_ratio",)
    parser.add_argument("--prune_n", type=float,default=0,help="The N in N:M structured sparsity",)
    parser.add_argument("--prune_m", type=float,default=0,help="The M in N:M structured sparsity",)
